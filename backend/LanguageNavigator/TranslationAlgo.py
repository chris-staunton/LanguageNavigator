...
if __name__ == '__main__':
    ...
    englishWords = []
    spanishWords = []
    with open('LanguageLists/spanishWords.txt', 'r') as f:
        englishWords = [line.strip() for line in f]

    with open('LAnguageLists/frenchWords.txt', 'r') as f:
    ...
    result = {"source": source, "target": target,"type": "LevPhon", "list": wordList}
    print(result)
